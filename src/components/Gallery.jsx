...
//         <div className="gallery-wrapper flex flex-wrap justify-center gap-x-[30px] gap-y-[35px] py-[10px] cursor-pointer">
//             <img src={pic1} alt="" className="gal-image" />
//             <img src={pic2} alt="" className="gal-image" />
//             <img src={pic3} alt="" className="gal-image" />
//             <img src={pic4} alt="" className="gal-image" />
//             <img src={pic5} alt="" className="gal-image" />
//             <img src={pic6} alt="" className="gal-image" />
//         </div>
